...
from everos_cloud.api_response import ApiResponse, T as ApiResponseT
import everos_cloud.models
from everos_cloud import rest
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.1.0-rc1/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(everos_cloud.models, klass)
