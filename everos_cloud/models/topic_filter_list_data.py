...
class TopicFilterListData(BaseModel):
    """
    TopicFilterListData
    """ # noqa: E501
    topics: List[TopicFilterItem] = Field(description="The matching topics, one page of them.")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="How many topics satisfy the all-tags-on-one-topic condition in total, counted before paging.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["topics", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "topics": [TopicFilterItem.from_dict(_item) for _item in obj["topics"]] if obj.get("topics") is not None else None,
            "total": obj.get("total")
        })
