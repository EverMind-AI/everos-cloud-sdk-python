...
class SuccessEnvelopeCategoryListData(BaseModel):
    """
    SuccessEnvelopeCategoryListData
    """ # noqa: E501
    request_id: StrictStr = Field(description="Request trace id (peer to data)")
    data: CategoryListData = Field(description="Endpoint-defined business result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CategoryListData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
