...
class TaskStatsResponseData(BaseModel):
    ...
    start: datetime = Field(description="Start of the window actually aggregated, after server-side clamping")
    total: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["by_status", "end", "start", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "by_status": TaskStatsResponseDataByStatus.from_dict(obj["by_status"]) if obj.get("by_status") is not None else None,
            "end": obj.get("end"),
            "start": obj.get("start"),
            "total": obj.get("total")
        })
