...
class ErrorEnvelope(BaseModel):
    ...
    """ # noqa: E501
    request_id: StrictStr = Field(description="Request trace id")
    error: ErrorBody = Field(description="Error detail (code + message)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["request_id", "error"]
