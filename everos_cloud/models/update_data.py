...
class UpdateData(BaseModel):
    ...
    unchanged: Optional[StrictBool] = Field(default=False, description="True when the patch equalled what was already stored — nothing was written and nothing downstream was triggered.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "app_id", "project_id", "user_id", "session_id", "timestamp", "sender_ids", "summary", "subject", "episode", "readable_episode", "type", "atomic_facts", "tags", "edited_at", "reflect_state", "unchanged"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unchanged": obj.get("unchanged") if obj.get("unchanged") is not None else False
        })
