...
class DocIngestBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "content", "category_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "content": ContentItem.from_dict(obj["content"]) if obj.get("content") is not None else None,
