...
class EditInput(BaseModel):
    ...
    """ # noqa: E501
    app_id: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default='default', description="Scope the profile lives in, defaulting to \"default\".")
    ...
    user_id: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="The user whose profile is being edited.")
