...
class AgentCaseItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "app_id", "project_id", "agent_id", "session_id", "task_intent", "approach", "quality_score", "key_insight", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if key_insight (nullable) is None
        # and model_fields_set contains the field
        if self.key_insight is None and "key_insight" in self.model_fields_set:
            _dict['key_insight'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task_intent": obj.get("task_intent"),
            "approach": obj.get("approach"),
            "quality_score": obj.get("quality_score"),
            "key_insight": obj.get("key_insight"),
