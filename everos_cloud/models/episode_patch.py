...
class EpisodePatch(BaseModel):
    ...
    """ # noqa: E501
    episode: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=8000)]] = None
    summary: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1000)]] = None
    subject: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=200)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["episode", "summary", "subject"]
