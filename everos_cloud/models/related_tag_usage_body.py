...
class RelatedTagUsageBody(BaseModel):
    """
    Candidate tag ids for ``POST /knowledge_bases/{kb_id}/tags``.
    """ # noqa: E501
    tag_ids: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=128)]], Field(min_length=1, max_length=10000)] = Field(description="Candidate opaque tag ids to check against the current live tree")
