...
class MessageItem(BaseModel):
    ...
    timestamp: Annotated[int, Field(strict=True, ge=1000000000000)] = Field(description="When the message was produced, as a UNIX timestamp in MILLISECONDS. A seconds-scale value is rejected with 422 rather than silently rescaled, because a window mixing the two would mis-order and mis-split.")
    content: Content
