...
class SuccessEnvelopeTopicListData(BaseModel):
    """
    SuccessEnvelopeTopicListData
    """ # noqa: E501
    request_id: StrictStr = Field(description="Request trace id (peer to data)")
    data: TopicListData = Field(description="Endpoint-defined business result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": TopicListData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
