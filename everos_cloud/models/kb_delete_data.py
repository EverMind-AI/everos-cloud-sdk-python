...
class KbDeleteData(BaseModel):
    ...
    KbDeleteData
    """ # noqa: E501
    id: StrictStr = Field(description="Deleted knowledge base id")
    deleted: StrictBool = Field(description="True if a live kb was soft-deleted; False if absent (idempotent)")
