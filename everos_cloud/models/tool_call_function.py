...
class ToolCallFunction(BaseModel):
    ...
    ToolCallFunction
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the function the assistant called.")
    arguments: StrictStr = Field(description="The call's arguments as a JSON-encoded string (OpenAI shape), not an object.")
