...
class CategoryCreateBody(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="Display name")
    description: Optional[StrictStr] = Field(default='', description="Feeds everalgo CategorySpec")
