...
class SignEnvelope(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["error", "request_id", "status", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": SignEnvelopeAllOfResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
