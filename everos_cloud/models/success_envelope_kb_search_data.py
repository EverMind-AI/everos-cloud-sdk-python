...
class SuccessEnvelopeKbSearchData(BaseModel):
    """
    SuccessEnvelopeKbSearchData
    """ # noqa: E501
    request_id: StrictStr = Field(description="Request trace id (peer to data)")
    data: KbSearchData = Field(description="Endpoint-defined business result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": KbSearchData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
