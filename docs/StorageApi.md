# everos_cloud_sdk.StorageApi

All URIs are relative to *https://api.evermind.ai*

Method | HTTP request | Description
------------- | ------------- | -------------
[**sign_objects**](StorageApi.md#sign_objects) | **POST** /api/v1/object/sign | Upload multimodal data (generate presigned upload info)
...
with everos_cloud_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = everos_cloud_sdk.StorageApi(api_client)
    sign_request = everos_cloud_sdk.SignRequest() # SignRequest | 
