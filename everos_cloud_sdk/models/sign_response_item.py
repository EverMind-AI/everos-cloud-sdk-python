...
class SignResponseItem(BaseModel):
    """
    SignResponseItem
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of object_signed_info
        if self.object_signed_info:
            _dict['objectSignedInfo'] = self.object_signed_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objectSignedInfo": SignedInfo.from_dict(obj["objectSignedInfo"]) if obj.get("objectSignedInfo") is not None else None
        })
