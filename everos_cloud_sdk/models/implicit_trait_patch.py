...
class ImplicitTraitPatch(BaseModel):
    """
    ...
    """ # noqa: E501
    trait: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if trait (nullable) is None
        # and model_fields_set contains the field
        if self.trait is None and "trait" in self.model_fields_set:
            _dict['trait'] = None
