...
class GetData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "episodes": [EpisodeItem.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
            "profiles": [ProfileItem.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None,
            "agent_cases": [AgentCaseItem.from_dict(_item) for _item in obj["agent_cases"]] if obj.get("agent_cases") is not None else None,
            "agent_skills": [AgentSkillItem.from_dict(_item) for _item in obj["agent_skills"]] if obj.get("agent_skills") is not None else None,
