...
class StorageApi:
    ...
    def sign_objects(
        ...
        _param = self._sign_objects_serialize(
    ...
    @validate_call
    def sign_objects_with_http_info(
        self,
        sign_request: SignRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def sign_objects_without_preload_content(
        self,
        sign_request: SignRequest,
        _request_timeout: Union[
            None,
    ...
    def _sign_objects_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/object/sign',
