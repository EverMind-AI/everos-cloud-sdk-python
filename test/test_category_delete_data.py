...
class TestCategoryDeleteData(unittest.TestCase):
    """CategoryDeleteData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryDeleteData:
        """Test CategoryDeleteData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryDeleteData`
        """
        model = CategoryDeleteData()
        if include_optional:
            return CategoryDeleteData(
                id = '',
                deleted = True
            )
        else:
    ...
    def testCategoryDeleteData(self):
        """Test CategoryDeleteData"""
