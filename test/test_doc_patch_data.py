...
class TestDocPatchData(unittest.TestCase):
    """DocPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocPatchData:
        """Test DocPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocPatchData`
        """
        model = DocPatchData()
        if include_optional:
            return DocPatchData(
