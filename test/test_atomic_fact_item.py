...
class TestAtomicFactItem(unittest.TestCase):
    """AtomicFactItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AtomicFactItem:
        """Test AtomicFactItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AtomicFactItem`
        """
        model = AtomicFactItem()
        if include_optional:
            return AtomicFactItem(
                id = '',
                content = ''
            )
        else:
