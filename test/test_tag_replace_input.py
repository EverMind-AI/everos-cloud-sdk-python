...
class TestTagReplaceInput(unittest.TestCase):
    """TagReplaceInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagReplaceInput:
        """Test TagReplaceInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagReplaceInput`
        """
        model = TagReplaceInput()
        if include_optional:
            return TagReplaceInput(
                memory_type = '0',
                memory_ids = [
                    ''
                    ],
