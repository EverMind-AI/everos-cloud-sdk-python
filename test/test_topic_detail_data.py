...
class TestTopicDetailData(unittest.TestCase):
    """TopicDetailData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopicDetailData:
        """Test TopicDetailData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopicDetailData`
        """
        model = TopicDetailData()
        if include_optional:
