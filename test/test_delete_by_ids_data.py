...
class TestDeleteByIdsData(unittest.TestCase):
    """DeleteByIdsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteByIdsData:
        """Test DeleteByIdsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteByIdsData`
        """
        model = DeleteByIdsData()
        if include_optional:
