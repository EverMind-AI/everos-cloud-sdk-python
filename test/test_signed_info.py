...
class TestSignedInfo(unittest.TestCase):
    """SignedInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignedInfo:
        """Test SignedInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignedInfo`
        """
        model = SignedInfo()
        if include_optional:
            return SignedInfo(
