...
class TestExplicitInfoData(unittest.TestCase):
    """ExplicitInfoData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplicitInfoData:
        """Test ExplicitInfoData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExplicitInfoData`
        """
        model = ExplicitInfoData()
        if include_optional:
            return ExplicitInfoData(
                category = '0',
                description = '0'
            )
        else:
