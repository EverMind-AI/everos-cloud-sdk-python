...
class TestTopicTagReplaceBody(unittest.TestCase):
    """TopicTagReplaceBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopicTagReplaceBody:
        """Test TopicTagReplaceBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopicTagReplaceBody`
        """
        model = TopicTagReplaceBody()
        if include_optional:
            return TopicTagReplaceBody(
                tag_ids = [
                    '0'
                    ],
                version = 0.0
    ...
    def testTopicTagReplaceBody(self):
        """Test TopicTagReplaceBody"""
