...
class TestDeleteByIdsInput(unittest.TestCase):
    """DeleteByIdsInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteByIdsInput:
        """Test DeleteByIdsInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteByIdsInput`
        """
        model = DeleteByIdsInput()
        if include_optional:
            return DeleteByIdsInput(
                memory_type = '0',
                memory_ids = [
                    ''
                    ],
