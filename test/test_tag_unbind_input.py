...
class TestTagUnbindInput(unittest.TestCase):
    """TagUnbindInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagUnbindInput:
        """Test TagUnbindInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagUnbindInput`
        """
        model = TagUnbindInput()
        if include_optional:
            return TagUnbindInput(
                memory_type = '0',
                memory_ids = [
                    ''
                    ],
