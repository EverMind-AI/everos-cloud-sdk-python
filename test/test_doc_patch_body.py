...
class TestDocPatchBody(unittest.TestCase):
    """DocPatchBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocPatchBody:
        """Test DocPatchBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocPatchBody`
        """
        model = DocPatchBody()
        if include_optional:
            return DocPatchBody(
