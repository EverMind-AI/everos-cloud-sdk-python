...
class TestTopicListData(unittest.TestCase):
    """TopicListData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopicListData:
        """Test TopicListData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopicListData`
        """
        model = TopicListData()
        if include_optional:
