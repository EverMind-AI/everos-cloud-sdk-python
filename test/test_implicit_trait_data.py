...
class TestImplicitTraitData(unittest.TestCase):
    """ImplicitTraitData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImplicitTraitData:
        """Test ImplicitTraitData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImplicitTraitData`
        """
        model = ImplicitTraitData()
        if include_optional:
            return ImplicitTraitData(
                trait = '0',
                description = '0'
            )
        else:
    ...
    def testImplicitTraitData(self):
        """Test ImplicitTraitData"""
