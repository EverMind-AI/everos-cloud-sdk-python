...
class TestFeedbackInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FeedbackInput:
        """Test FeedbackInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedbackInput`
        """
        model = FeedbackInput()
        if include_optional:
            return FeedbackInput(
                memory_type = 'episode',
                memory_id = '62ECB020842930cc01FFCCfe01234567891011121314151617181920212223',
                item_id = 'it_f325375e030fccba00917317',
                rating = 'positive',
