...
class TestSignObjectItem(unittest.TestCase):
    """SignObjectItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignObjectItem:
        """Test SignObjectItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignObjectItem`
        """
        model = SignObjectItem()
        if include_optional:
            return SignObjectItem(
                file_id = '',
                file_name = '',
                file_type = 'image'
            )
