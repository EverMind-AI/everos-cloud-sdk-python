...
class TestTagReplaceData(unittest.TestCase):
    """TagReplaceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagReplaceData:
        """Test TagReplaceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagReplaceData`
        """
        model = TagReplaceData()
        if include_optional:
            return TagReplaceData(
                matched = 56,
                requested = 56
            )
        else:
