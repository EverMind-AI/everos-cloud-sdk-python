...
class TestProfileItem(unittest.TestCase):
    """ProfileItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileItem:
        """Test ProfileItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileItem`
        """
        model = ProfileItem()
        if include_optional:
            return ProfileItem(
