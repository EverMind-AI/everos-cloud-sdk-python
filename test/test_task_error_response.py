...
class TestTaskErrorResponse(unittest.TestCase):
    """TaskErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskErrorResponse:
        """Test TaskErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskErrorResponse`
        """
        model = TaskErrorResponse()
        if include_optional:
            return TaskErrorResponse(
                error = everos_cloud.models.task_error_response_error.TaskErrorResponse_error(
                    code = '', 
                    message = '', 
                    type = '', )
            )
    ...
    def testTaskErrorResponse(self):
        """Test TaskErrorResponse"""
