...
class TestSuccessEnvelopeUpdateData(unittest.TestCase):
    """SuccessEnvelopeUpdateData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuccessEnvelopeUpdateData:
        """Test SuccessEnvelopeUpdateData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuccessEnvelopeUpdateData`
        """
        model = SuccessEnvelopeUpdateData()
        if include_optional:
            return SuccessEnvelopeUpdateData(
                request_id = '',
                data = everos_cloud.models.update_data.UpdateData(
                    id = '', 
                    app_id = '', 
                    project_id = '', 
                    user_id = '', 
    ...
    def testSuccessEnvelopeUpdateData(self):
        """Test SuccessEnvelopeUpdateData"""
