...
class TestTaskErrorResponseError(unittest.TestCase):
    """TaskErrorResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskErrorResponseError:
        """Test TaskErrorResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskErrorResponseError`
        """
        model = TaskErrorResponseError()
        if include_optional:
            return TaskErrorResponseError(
                code = '',
                message = '',
                type = ''
            )
    ...
    def testTaskErrorResponseError(self):
        """Test TaskErrorResponseError"""
