...
class TestFlushData(unittest.TestCase):
    """FlushData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlushData:
        """Test FlushData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlushData`
        """
        model = FlushData()
        if include_optional:
            return FlushData(
