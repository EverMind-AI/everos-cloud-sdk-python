...
class TestRelatedTagUsageBody(unittest.TestCase):
    """RelatedTagUsageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedTagUsageBody:
        """Test RelatedTagUsageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedTagUsageBody`
        """
        model = RelatedTagUsageBody()
        if include_optional:
            return RelatedTagUsageBody(
                tag_ids = [
                    '0'
                    ]
            )
    ...
    def testRelatedTagUsageBody(self):
        """Test RelatedTagUsageBody"""
