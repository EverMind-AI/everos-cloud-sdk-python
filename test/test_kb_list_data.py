...
class TestKbListData(unittest.TestCase):
    """KbListData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KbListData:
        """Test KbListData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KbListData`
        """
        model = KbListData()
        if include_optional:
            return KbListData(
