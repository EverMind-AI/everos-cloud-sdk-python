...
class TestExplicitInfoPatch(unittest.TestCase):
    """ExplicitInfoPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplicitInfoPatch:
        """Test ExplicitInfoPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExplicitInfoPatch`
        """
        model = ExplicitInfoPatch()
        if include_optional:
            return ExplicitInfoPatch(
                category = '0',
                description = '0'
            )
        else:
    ...
    def testExplicitInfoPatch(self):
        """Test ExplicitInfoPatch"""
