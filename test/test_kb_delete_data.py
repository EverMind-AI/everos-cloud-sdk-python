...
class TestKbDeleteData(unittest.TestCase):
    """KbDeleteData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KbDeleteData:
        """Test KbDeleteData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KbDeleteData`
        """
        model = KbDeleteData()
        if include_optional:
            return KbDeleteData(
