...
class TestDocListData(unittest.TestCase):
    """DocListData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocListData:
        """Test DocListData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocListData`
        """
        model = DocListData()
        if include_optional:
            return DocListData(
