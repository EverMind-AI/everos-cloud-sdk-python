...
class TestDocData(unittest.TestCase):
    """DocData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocData:
        """Test DocData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocData`
        """
        model = DocData()
        if include_optional:
            return DocData(
