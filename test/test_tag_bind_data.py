...
class TestTagBindData(unittest.TestCase):
    """TagBindData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagBindData:
        """Test TagBindData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagBindData`
        """
        model = TagBindData()
        if include_optional:
            return TagBindData(
