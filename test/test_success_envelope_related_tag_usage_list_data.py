...
class TestSuccessEnvelopeRelatedTagUsageListData(unittest.TestCase):
    """SuccessEnvelopeRelatedTagUsageListData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuccessEnvelopeRelatedTagUsageListData:
        """Test SuccessEnvelopeRelatedTagUsageListData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuccessEnvelopeRelatedTagUsageListData`
        """
        model = SuccessEnvelopeRelatedTagUsageListData()
        if include_optional:
            return SuccessEnvelopeRelatedTagUsageListData(
                request_id = '',
                data = { }
            )
        else:
    ...
    def testSuccessEnvelopeRelatedTagUsageListData(self):
        """Test SuccessEnvelopeRelatedTagUsageListData"""
