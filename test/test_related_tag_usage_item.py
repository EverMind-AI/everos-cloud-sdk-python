...
class TestRelatedTagUsageItem(unittest.TestCase):
    """RelatedTagUsageItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedTagUsageItem:
        """Test RelatedTagUsageItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedTagUsageItem`
        """
        model = RelatedTagUsageItem()
        if include_optional:
            return RelatedTagUsageItem(
                id = '0',
                document_count = 56
            )
        else:
    ...
    def testRelatedTagUsageItem(self):
        """Test RelatedTagUsageItem"""
